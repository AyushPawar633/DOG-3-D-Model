...
function App() {
  ...
  return (
   ...
   <main>
    ...
    <img id='packing' src="/models/packing.png" alt="" />
    <img id='pier' src="/models/navy.png" alt="" />
    <img id='chicago' src="/models/chicago.png" alt="" />
    ...
    <section id='section-1'>
      ...
      <div className="middle">
        <div className="left">
          <h1>WE <br/> MAKE <br/> 3-D  <br/> WOLF <br/> </h1>
        </div>
    ...
    <section id='section-2'>
      <div className="titles">
        ...
        <div img-title="packing" className="title">
          <small>2020 - ONGOING</small>
          <h1>WOLF PACKING</h1>
        </div>
        <div img-title="pier" className="title">
          <small>2020 - ONGOING</small>
          <h1> Navy Pier</h1>
        </div>
