...
const Dog = () => {
  ...
  const[normalMap ] = (useTexture(["/models/dogs_normal.jpg",])).map(texture =>{
    texture.flipY = false
    texture.colorSpace = THREE.SRGBColorSpace
    return texture
  })

  const [branchMap, branchNormalMap] = (useTexture(["/models/branches_diffuse.jpg","/models/branches_normals.jpg"])).map(texture =>{
    texture.colorSpace = THREE.SRGBColorSpace
    return texture
  })
 ...
 DogMaterial.onBeforeCompile = onBeforeCompile
  ...
  useGSAP(()=> {
   ...
   useEffect(() => {
        ...
        document.querySelector(`.title[img-title="packing"]`).addEventListener("mouseenter", () => {
        ...
        document.querySelector(`.title[img-title="pier"]`).addEventListener("mouseenter", () => {
